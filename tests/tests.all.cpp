...
TEST_GROUP_RUNNER(optional)
{
	...
	RUN_TEST_CASE(optional, Move_constructing_an_optional_with_an_optional_with_a_value_set);
	RUN_TEST_CASE(optional, Move_constructing_an_optional_with_an_optional_with_no_value_set);
	RUN_TEST_CASE(optional, Move_assigning_an_optional_with_no_value_set_with_an_optional_with_no_value_set);
	RUN_TEST_CASE(optional, Move_assigning_an_optional_with_no_value_set_with_an_optional_with_a_value_set);
	RUN_TEST_CASE(optional, Move_assigning_an_optional_with_a_value_set_with_an_optional_with_a_value_set);
	RUN_TEST_CASE(optional, Move_assigning_an_optional_with_a_value_set_with_an_optional_with_no_value_set);
	RUN_TEST_CASE(optional, Copy_assigning_an_optional_with_no_value_set_with_an_optional_with_no_value_set);
	RUN_TEST_CASE(optional, Copy_assigning_an_optional_with_no_value_set_with_an_optional_with_a_value_set);
	RUN_TEST_CASE(optional, Copy_assigning_an_optional_with_a_value_set_with_an_optional_with_a_value_set);
	RUN_TEST_CASE(optional, Copy_assigning_an_optional_with_a_value_set_with_an_optional_with_no_value_set);
}
...
TEST_GROUP_RUNNER(safe_type)
{
	...
	RUN_TEST_CASE(safe_type, post_increment_safe_types);
